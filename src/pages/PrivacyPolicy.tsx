export default function PrivacyPolicy() {
    return (
        <div className="max-w-3xl mx-auto px-6 py-20 leading-relaxed min-h-screen bg-background text-foreground">
            <h1 className="text-4xl font-black mb-10 font-serif">Privacy Policy</h1>
            <div className="space-y-8 text-muted-foreground font-medium">
                <section>
                    <h2 className="text-foreground text-xl font-bold mb-4 font-serif">1. Local-First Processing</h2>
                ...
                <section>
                    <h2 className="text-foreground text-xl font-bold mb-4 font-serif">2. AI Data Transmission</h2>
                ...
                <section>
                    <h2 className="text-foreground text-xl font-bold mb-4 font-serif">3. License Management</h2>
